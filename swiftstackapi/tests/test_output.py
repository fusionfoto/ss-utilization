...
class TestCsvUtilizationWriter(TestCase):
    def setUp(self):
        self.test_data = {'1': {'account1': [{'start': '2013-08-31 23:30:00Z',
                                ...
                                'account2': [{'start': '2013-08-31 23:30:00Z',
                                             ...
                                             {'start': "2013-09-01 02:30:00Z",
                                              ...
                                              'bytes_used': 500000,
                                              'pct_complete': 100.0}]},
                          '2': {'account1': [{'start': '2013-08-31 23:30:00Z',
                                              'end': "2013-09-01 00:30:00Z",
                                              'container_count': 5000,
                                              'object_count': 50000,
                                              'bytes_used': 500000,
        ...
        self.expected_csv = \
            ...
            """account1,2013-09-01 00:30:00Z,2013-09-01 01:30:00Z,5000,50000,500000,100.0,1\r\n""" \
            """account1,2013-09-01 01:30:00Z,2013-09-01 02:30:00Z,5000,50000,500000,100.0,1\r\n""" \
            """account1,2013-09-01 02:30:00Z,2013-09-01 03:30:00Z,5000,50000,500000,100.0,1\r\n""" \
            ...
            """account1,2013-09-01 00:30:00Z,2013-09-01 01:30:00Z,5000,50000,500000,100.0,2\r\n""" \
